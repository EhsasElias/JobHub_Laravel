        ...
        <section class="w-75 me-auto">
            ...
            <section class="">
                <div class="bg-white rounded-4 p-5 mx-2">
                    <h1 class="fw-bolder">Education & Training</h1>
                    ...
                    <table class="table table-borderless my-5">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Bacaloria in Information Technology</td>

                                <td class="link-secondary">
                                    <i class="fa fa-pencil p-2" data-bs-toggle="modal" href="#exampleModalToggle2"
                                        role="button"></i>
                                    <i class="fa fa-trash-o p-2 text-danger exper" data-bs-toggle="modal"
                    ...
                    <table class="table table-borderless my-5">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Training In IOM Orginazation</td>
                            ...
                            <tr>
                                ...
                                <td>Training In SHS Orginazation</td>
                                <td class="link-secondary">
                                    <i class="fa fa-pencil p-2" data-bs-toggle="modal" href="#exampleModalToggle2"
                                        role="button"></i>
                                    <i class="fa fa-trash-o p-2 text-danger exper" data-bs-toggle="modal"
                            ...
                            <tr>
                                ...
                                <td>Training In UN Orginazation
                                </td>
                                <td class="link-secondary">
                                    <i class="fa fa-pencil p-2" data-bs-toggle="modal" href="#exampleModalToggle2"
                                        role="button"></i>
                    ...
                    <div class="modal fade" id="exampleModalToggle2" aria-hidden="true"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body m-auto">
                                    <input type="text" placeholder="Education OR Training"
                                        class="form-control p-3 px-5 rounded-4">
                                </div>
                                <div class="modal-footer m-auto border-top-0">
