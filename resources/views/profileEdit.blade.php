                ...
                <div class="bg-white rounded-4 p-5 mx-2">
                   ...
                   <div class="row">
                    <div class="input-group mb-3 mt-4 col-lg-12">
                        <label class="w-100 my-2" for="">Name</label>
                    ...
                    <div class="input-group mb-3 mt-4 d-flex justify-content-between">
                        <div class="row w-100 justify-content-between">
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control rounded-pill p-3 " placeholder="Ex.Web Designer">
                            
                            </div>
                           
                           <div class="col-lg-6">
                            <label class=" my-2 " for="">Location</label>
                            <input type="text" class="form-control rounded-pill p-3  " placeholder="Ex. Sanaa">
                       ...
                       <div class="input-group mb-3 mt-4 d-flex justify-content-between">
                        <div class="row w-100 justify-content-between">
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control rounded-pill p-3 " placeholder="ehsas.1998000@gmail.com">
                            
                            </div>
                           
                           <div class="col-lg-6">
                            <label class=" my-2 " for="">Phone</label>
                            <input type="text" class="form-control rounded-pill p-3  " placeholder="+967 777 777 777">
                    ...
                    <div class="input-group mb-3 mt-4">
                        ...
                        <input type="file" class="form-control rounded-4 p-3 py-5 text-center" placeholder="Upload Your Img" style="border:1px dotted #ced4da !important;height: 150px;">
                    
                    </div>
                    <div class="input-group mb-3 mt-4">
                        <label class="w-100 my-2" for="">About you</label>
                        <input type="text" class="form-control p-3" placeholder="Type your info here..." style="height: 150px;border-radius: 20px;">
