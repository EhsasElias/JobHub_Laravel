                ...
                <div class="bg-white rounded-4 p-5 mx-2">
                   ...
                   <div class="row">
                    <div class="input-group mb-3 mt-4 col-lg-12">
                        ...
                        <input type="text" class="form-control rounded-pill p-3" placeholder="Job Title">
                   ...
                   <div class="row">
                    <div class="input-group mb-3 mt-4 col-lg-12">
                        ...
                        <textarea  class="form-control rounded-pill p-3" placeholder="Details">
                        </textarea>
                   ...
                   <div class="row">
                    <div class="input-group mb-3 mt-4 col-lg-12">
                        ...
                        <input type="number" class="form-control rounded-pill p-3" >
