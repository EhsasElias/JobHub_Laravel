            ...
            <form class=" signin  d-flex justify-content-end m-1 align-items-start">
                ...
                <div class="dropdown d-flex align-items-center m-lg-5">
                    ...
                    <ul class="dropdown-menu p-4 rounded-4" aria-labelledby="dropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="/profileEditadmin">Edit Profile</a></li>
                        <li><a class="dropdown-item" href="/logout">Logout</a></li>
                    </ul>
                </div>
                </li>
            </form>
            <form class="" action="{{ route('updateuserinfo') }}" method="POST">
                <div class="bg-white rounded-4 p-5 mx-2">
                    <h1 class="fw-bolder">Company Profile</h1>
                    ...
                    <div class="row">
                        <div class="input-group mb-3 mt-4 col-lg-12">
                            ...
                            <input type="text" name="company_email" class="form-control rounded-pill p-3"
                    ...
                    <div class="row">
                        <div class="input-group mb-3 mt-4 col-lg-12">
                            ...
                            <input type="text" name="company_phone" class="form-control rounded-pill p-3"
                                placeholder="num">
                    ...
                    <div class="row">
                        <div class="input-group mb-3 mt-4 col-lg-12">
                            ...
                            <input type="password" name="company_pass" class="form-control rounded-pill p-3"
                    ...
                    <div class="row">
                        <div class="input-group mb-3 mt-4 col-lg-12">
                            ...
                            <input type="password" name="company_conf_pass" class="form-control rounded-pill p-3"
                    ...
                    <div class="input-group mb-3 mt-4">
                        ...
                        <input type="file" name="logo_img" class="form-control rounded-4 p-3 py-5 text-center"
                            placeholder="Upload Your Img" style="border:1px dotted #ced4da !important;height: 150px;">
                    </div>

                </div>
                <div class="d-flex">
                    <a type="submit" class="btn bg-darkBlue text-light rounded-4 border-0 p-3 px-5 m-auto Download"
                        href="">Update</a>
                </div>
